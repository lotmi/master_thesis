...
def get_sliced_prediction(
    ...
    # THESE TWO FUNCTION ARGUMENTS WERE ADDED:
    ...
    try:
        ...
        slice_image_result = slice_image(
            ...
            # ADJUSTMENT BY LOTTE MICHELS
            # THESE TWO FUNCTION ARGUMENTS WERE ADDED:
            ROI_informed=ROI_informed, # boolean argument to indicate if patches are created by a sliding window (false) or bone detector (true)
            bone_detection_model=bone_detection_model, # if ROI_informed = True, a bone detector model (pre-trained YOLOv5) should be passed as an additional argument
        )
