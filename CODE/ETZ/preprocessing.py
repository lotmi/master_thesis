...
3. Slicing: creating 2D axial slices form the CT scans and extracting the corresponding lesion bounding boxes
...
datasplit = {"train":range(0, 74), "val":range(74, 89), "test":range(89, 104)}
...
slice_outputpath = '/wecare/home/lotte/Thesis/DATA/ETZ/YOLO/images'
props_outputpath = '/wecare/home/lotte/Thesis/CODE/ETZ/slice_properties.csv' 
...
# Access data
props_inputpath = '/wecare/home/lotte/Thesis/CODE/ETZ/slice_properties.csv'  
...
train_sample = pd.read_csv('/wecare/home/lotte/Thesis/CODE/ETZ/sampled_data_properties.csv', dtype={'scan_nr': str, 'take': int})
...
# YOLO
yolo_src_pth = '/wecare/home/lotte/Thesis/DATA/ETZ/YOLO/'
yolo_dst_pth = '/wecare/home/lotte/Thesis/DATA/ETZ/YOLO_sampled/'
